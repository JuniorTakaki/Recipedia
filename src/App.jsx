...
export default function App() {
    ...
    <div className="w-full h-full   ">
      <div className="container mx-auto px-4 ">
        <header className="w-full py-4">
          <div className="flex justify-between items-center px-4 md:px-8 lg:px-28">
            <div className="flex items-center space-x-2">
              <img src="recipedia/src/assets/logo.png" alt="logo" className="w-12 h-10" />
            ...
            <div className="flex space-x-4">
              <img src="recipedia/src/assets/Vector.png" alt="search" className="w-6 h-6" />
              <img src="recipedia/src/assets/person.png" alt="person" className="w-6 h-6" />
            </div>
          </div>
        </header>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center w-full px-4 md:px-8 lg:px-28 py-8">
          ...
          <img src="recipedia/src/assets/Group 3.png" alt="Group 3" className="w-full max-w-xs md:max-w-md lg:max-w-lg" />
        </div>
        ...
        <div className=" grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-6 ">
          <div className="bg-slate-100 shadow-xl rounded-xl px-2 pt-1 ">
            <img src="recipedia/src/assets/creamy salad.jpg" alt="" className="w-full h-52 object-cover rounded-t-xl" />
            <div className="flex justify-evenly text-green-700 text-sm font-semibold pt-2">
              <p className="flex items-center gap-2"><img src="recipedia/src/assets/time.png" className="w-4 h-4" />10 Mins</p>
              <p className="flex items-center gap-2"><img src="recipedia/src/assets/foodperson.png" className="w-4 h-4" />2 Serving</p>
              <p className="flex items-center gap-2"><img src="recipedia/src/assets/easy2.png" className="w-4 h-4" />Easy</p>
            </div>
          ...
          <div className="bg-slate-100 shadow-xl rounded-xl px-2 pt-1">
            <img src="recipedia/src/assets/Tofu tomatoes soup.jpg" alt="" className="w-full h-52 object-cover rounded-t-xl" />
            <div className="flex justify-evenly text-green-700 text-sm font-semibold pt-2">
              <p className="flex items-center gap-2"><img src="recipedia/src/assets/time.png" className="w-4 h-4" />15 Mins</p>
              <p className="flex items-center gap-2"><img src="recipedia/src/assets/foodperson.png" className="w-4 h-4" />3 Serving</p>
              <p className="flex items-center gap-2"><img src="recipedia/src/assets/easy2.png" className="w-4 h-4" />Easy</p>
            </div>
            <div className=" w-full h-20 grid grid-cols-1">
          ...
          <div className="bg-slate-100 shadow-xl rounded-xl px-2 pt-1">
            <img src="recipedia/src/assets/Crunchy potatoes.jpg" alt="" className="w-full h-52 object-cover rounded-t-xl" />
            <div className="flex justify-evenly text-green-700 text-sm font-semibold pt-2">
              <p className="flex items-center gap-2"><img src="recipedia/src/assets/time.png" className="
            w-4 h-4"/>15 Mins</p>
              <p className="flex items-center gap-2"><img src="recipedia/src/assets/foodperson.png" className="w-4 h-4" />3 Serving</p>
              <p className="flex items-center gap-2"><img src="recipedia/src/assets/easy2.png" className="w-4 h-4" />Easy</p>
            </div>
          ...
          <div className="bg-slate-100 shadow-xl rounded-xl px-2 pt-1 ">
            <img src="recipedia/src/assets/image 10.png" alt="" className="w-full h-52 object-cover rounded-t-xl" />
            <div className="flex justify-evenly text-green-700 text-sm font-semibold pt-2">
              <p className="flex items-center gap-2"><img src="recipedia/src/assets/time.png" className="w-4 h-4" />25 Mins</p>
              <p className="flex items-center gap-2"><img src="recipedia/src/assets/foodperson.png" className="w-4 h-4" />2 Serving</p>
              <p className="flex items-center gap-2"><img src="recipedia/src/assets/easy2.png" className="w-4 h-4" />Medium</p>
            </div>
            <div className=" w-full h-20 grid grid-cols-1 ">
          ...
          <div className="bg-slate-100 shadow-xl rounded-xl px-2 pt-1">
            <img src="recipedia/src/assets/image 6.png" alt="" className="w-full h-52 object-cover rounded-t-xl" />
            <div className="flex justify-evenly text-green-700 text-sm font-semibold pt-2">
              <p className="flex items-center gap-2"><img src="recipedia/src/assets/time.png" className="w-4 h-4" />30 Mins</p>
              <p className="flex items-center gap-2"><img src="recipedia/src/assets/foodperson.png" className="w-4 h-4" />1 Serving</p>
              <p className="flex items-center gap-2"><img src="recipedia/src/assets/easy2.png" className="w-4 h-4" />Easy</p>
            </div>
            <div className=" w-full h-20 grid grid-cols-1">
          ...
          <div className="bg-slate-100 shadow-xl rounded-xl px-2 pt-1">
            <img src="recipedia/src/assets/image 9.png" alt="" className="w-full h-52 object-cover rounded-t-xl" />
            <div className="flex justify-evenly text-green-700 text-sm font-semibold pt-2">
              <p className="flex items-center gap-2"><img src="recipedia/src/assets/time.png" className="
            w-4 h-4"/>20 Mins</p>
              <p className="flex items-center gap-2"><img src="recipedia/src/assets/foodperson.png" className="w-4 h-4" />1 Serving</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-6 w-full h-full">
                  <SwiperSlide className='pb-10'>
                    <div className="bg-slate-100 shadow-xl rounded-xl px-12 pt-14 pb-4 min-h-[578px] h-full flex flex-col flex-wrap">
                      <div className="flex justify-start gap-x-4">
                        <img src="recipedia/src/assets/user.png" alt="" className="rounded-full" />
                        <div>
                      ...
                      <div className="flex flex-row pt-6">
                        <img src="recipedia/src/assets/stars.png" alt="Stars" />
                        <img src="recipedia/src/assets/stars.png" alt="Stars" />
                        <img src="recipedia/src/assets/stars.png" alt="Stars" />
                        <img src="recipedia/src/assets/stars.png" alt="Stars" />
                        <img src="recipedia/src/assets/stars.png" alt="Stars" />
                      ...
                      <div className="w-full pb-4">
                        ...
                        <img src="recipedia/src/assets/frame 477.png" alt="" className="w-full h-[260px] flex justify-center rounded-2xl" />
                      </div>
                      <div className="flex justify-evenly font-semibold">
                        <div className="flex flex-row w-full items-center gap-x-4">
                          <p className="flex items-center gap-x-2 "><img src="recipedia/src/assets/like.png" className="w-4 h-4" /> 2</p>
                          <p className="flex items-center gap-x-2"><img src="recipedia/src/assets/share.png" className="w-4 h-4" /> Share</p>
                        </div>
                      </div>
                    </div>
                  </SwiperSlide>
                  ...
                  <SwiperSlide>
                    <div className="bg-slate-100 shadow-xl rounded-xl px-12 pt-14 pb-4 min-h-[578px] h-full flex flex-col">
                      <div className="flex justify-start gap-x-4">
                        <img src="recipedia/src/assets/image 18.png" alt="" className="rounded-full" />
                        <div>
                      ...
                      <div className="w-full pb-4">
                        ...
                        <img src="recipedia/src/assets/food.png" alt="" className=" w-full h-[260px] flex justify-center rounded-2xl" />
                      </div>
                      <div className="flex justify-evenly font-semibold">
                        <div className="flex flex-row w-full items-center gap-x-4">
                          <p className="flex items-center gap-x-2"><img src="recipedia/src/assets/like.png" className="w-4 h-4" /> 3</p>
                          <p className="flex items-center gap-x-2"><img src="recipedia/src/assets/share.png" className="w-4 h-4" /> Share</p>
                        </div>
                      </div>
                    </div>
                  ...
                  <SwiperSlide>
                    <div className="bg-slate-100 shadow-xl rounded-xl px-12 pt-14 pb-4 min-h-[578px] h-full flex flex-col">
                      <div className="flex justify-start gap-x-4">
                        <img src="recipedia/src/assets/image 19.png" alt="" className="rounded-full" />
                        <div>
                      ...
                      <div className="w-full pb-4">
                        ...
                        <img src="recipedia/src/assets/2.png" alt="" className=" w-full h-[260px] flex justify-center rounded-2xl" />
                      </div>
                      <div className="flex justify-evenly font-semibold">
                        <div className="flex flex-row w-full items-center gap-x-4">
                          <p className="flex items-center gap-x-2"><img src="recipedia/src/assets/like.png" className="w-4 h-4" /> 1</p>
                          <p className="flex items-center gap-x-2"><img src="recipedia/src/assets/share.png" className="w-4 h-4" /> Share</p>
                        </div>
                      </div>
                    </div>
                  ...
                  <SwiperSlide>
                    <div className="bg-slate-100 shadow-xl rounded-xl px-12 pt-14 pb-4 min-h-[578px] h-full flex flex-col">
                      <div className="flex justify-start gap-x-4">
                        <img src="recipedia/src/assets/image 20.png" alt="" className="rounded-full" />
                        <div>
                      ...
                      <div className="w-full pb-4">
                        ...
                        <img src="recipedia/src/assets/image 1.png" alt="" className=" w-full h-[260px] flex justify-center rounded-2xl" />
                      </div>
                      <div className="flex justify-evenly font-semibold">
                        <div className="flex flex-row w-full items-center gap-x-4">
                          <p className="flex items-center gap-x-2"><img src="recipedia/src/assets/like.png" className="w-4 h-4" /> 5</p>
                          <p className="flex items-center gap-x-2"><img src="recipedia/src/assets/share.png" className="w-4 h-4" /> Share</p>
                        </div>
                      </div>
                    </div>
  ...
  <div className="h-auto lg:h-96 w-full md:w-5/6 rounded-lg p-6 md:p-12 gap-3 bg-[#046E1B] text-white font-inter font-semibold flex flex-col md:flex-row">
    ...
    <div className="flex items-center md:items-end w-full h-full mt-6 md:mt-0">
      <img src="recipedia/src/assets/iPhone 15 Pro.png" alt="iPhone 15 Pro" className="w-full md:w-auto" />
    </div>
  </div>
</div>
<div className="container mx-auto w-full h-full font-semibold pb-20 px-4">
  <div className="flex items-center w-full h-full pb-4 gap-1">
    <img src="recipedia/src/assets/logo.png" alt="logo.png" className="w-6 h-6 md:w-4 md:h-4 object-cover object-center" />
